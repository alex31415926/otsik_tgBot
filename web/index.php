...
$run2 = "E: && cd e:\_py\bots\_MariBot && python stat_count.py";
exec($run2);
...
$school = explode(" ",fgets($fh)); //добавить все роли
...
<form action="http://127.0.0.1/denwer/bot/index2.php" method="post">
   <p><select name="role" size="7" multiple>
    	<option selected value="role_1">Студент</option>
   	<option value="role_2">Школьник</option>
   	<option value="role_3">Гос. служащий</option>
   	<option value="role_4">Пенсионер</option>
   	<option value="role_5">Фрилансер</option>
	<option value="role_6">Безработный</option>
	<option value="role_7">Домохозяйка</option>
   </select>
...
<td bgcolor="yellow" align="center"><b>Шкала</b></td>
...
<td align="center">1. Выраженность аффективных переживаний субъекта и его отношения к ним</td>
...
<td align="center">2. Степень опредмеченности желания субъекта</td>
...
<td align="center">3. Cтепень активности взаимодействия субъекта с реальностью</td>
...
<td align="center">4. Умение прогнозировать результат предпринимаемых действий</td>
...
<td align="center">5. Межличностное взаимодействие субъекта</td>
...
<td align="center">6. Cостояние самооценки субъекта</td>
...
<td align="center">7. Отношение к негативному опыту и степень фиксированности на имеющихся затруднениях</td>
...
<td bgcolor="yellow" align="center"><b>Механизм</b></td>
...
<td align="center">самоопредмечивания</td>
...
<td align="center">самооценивания</td>
...
<td align="center">самоформирования</td>
...
<td align="center">самоотеждествления</td>
...
<td align="center">самоопределения</td>
...
<td align="center">самоодобрения</td>
